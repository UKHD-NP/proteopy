...
def peptides_long_from_df(
    ...
    *,
    ...
    peptides_annotation_df: pd.DataFrame | None = None,
    ...
    if peptides_annotation_df is not None:
        peptide_annotation_df = peptides_annotation_df.copy()
        rename_map_peptide = {
            actual: canonical
            for canonical, actual in column_aliases.items()
...
def peptides_long(
    ...
    *,
    ...
    peptides_annotation_df = (
        pd.read_csv(peptides_annotation_path, sep=sep)
        if peptides_annotation_path
        else None
    )
