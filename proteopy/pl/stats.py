...
def _plot_completeness_partition(
    ...
    """Plot boxplots of completeness partitioned by a grouping
    column."""
...
def completeness(
    ...
    """Plot a histogram of completeness across observations or
    variables.
...
def n_var_per_sample(
    ...
    *,
    ...
    """Plot the number of detected variables (peptides or protein) per
    sample.
...
def n_cat1_per_cat2_hist(
    ...
    """Plot the distribution of the number of first-category entries per
    second category.
...
def cv_by_group(
    ...
    """Compute per-group coefficients of variation and plot their
    distributions.
...
def hclustv_profiles_heatmap(
    ...
    """Plot a clustered heatmap of variable profiles across samples or
    groups.
